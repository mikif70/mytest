...
func init() {
	...
	flag.StringVar(&config.cmd, "c", config.cmd, "cmd")
}
...
func main() {
	...
	case "get":
		msg = []string{
			"*2" + NL + "$3" + NL + "GET" + NL + "$32" + NL + "dtest01@tiscali.it/quota/storage" + NL,
			"*2" + NL + "$3" + NL + "GET" + NL + "$33" + NL + "dtest01@tiscali.it/quota/messages" + NL,
		}
	case "recalc":
		msg = []string{
			"*1" + NL + "$5" + NL + "MULTI" + NL + "*2" + NL + "$3" + NL + "DEL" + NL + "$32" + NL +
				"dtest01@tiscali.it/quota/storage" + NL + "*2" + NL + "$3" + NL + "DEL" + NL + "$33" + NL +
				"dtest01@tiscali.it/quota/messages" + NL + "*3" + NL + "$3" + NL + "SET" + NL + "$32" + NL +
				"dtest01@tiscali.it/quota/storage" + NL + "$9" + NL + "190544684" + NL + "*3" + NL + "$3" + NL +
				"SET" + NL + "$33" + NL + "dtest01@tiscali.it/quota/messages" + NL + "$4" + NL + "2963" + NL +
				"*1" + NL + "$4" + NL + "EXEC" + NL,
		}
	default:
		msg = []string{
